  ...
  return (
    <div className="w-full">
      <button
        ...
        type="button"
        className="w-full flex items-center justify-center gap-3 py-3 sm:py-4 px-4 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm sm:text-base shadow-sm hover:shadow"
      >
